...
const Footer = () => {
  return (
    <div className="bg-black px-8 lg:px-10 xl:px-12 2xl:px-16 py-8 flex flex-col justify-center items-center ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center items-center ">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-gray-400 text-xs pb-1">Holding</p>
          <p className="text-gray-400 text-xs pb-1">439 Gurudashpur</p>
          <p className="text-gray-400 text-xs pb-1">Natore, Bangladesh</p>
          <p className="text-gray-400 text-xs pb-1">www.maddyfx.com</p>
          <p className="text-gray-400 text-xs pb-1">+8801776603040</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-[#f2994a] font-semibold text-sm pb-2">
            USEFULL LINK
          </h1>
          <div className="flex flex-col justify-center items-center">
            <Link
              href="/"
              className="text-xs text-gray-400 pb-1 hover:text-gray-300"
            >
              Portfolio
            </Link>
            <Link
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <Link href="/gallery/socks">Socks</Link>
          <Link href="/gallery/caps">Caps</Link>
          <Link href="/gallery/logos">Logos</Link>
          <Link href="/gallery/tshirts">Tshirts</Link>
          <Link href="/gallery">Others</Link>
        </div>
