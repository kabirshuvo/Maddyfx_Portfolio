...
import { LogoImages, initialDesigns } from "@/lib/galleryImageData/logoImages";
...
const LogoDesigns: React.FC = () => {
  const [selectedImage, setSelectedImage] = useState<LogoImages | null>(null);

  const handleImageClick = (design: LogoImages) => {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col justify-center items-center bg-emerald-700 h-80">
        <h1 className="text-5xl text-white">Logo Images</h1>
        <GalleryNavBar />
      </div>
