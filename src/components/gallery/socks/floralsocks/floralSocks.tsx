...
const FloralSocks: React.FC = () => {
  const [selectedImage, setSelectedImage] =
    useState<FloralSockDesignImages | null>(null);

  const handleImageClick = (design: FloralSockDesignImages) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {selectedImage && (
        <Modal
          onClose={closeModal}
          images={FloralSockInitialImages}
          initialIndex={FloralSockInitialImages.findIndex(
